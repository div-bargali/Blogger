...
SECRET_KEY = 'mg2!6o_8v9@1#%mu1uieb-m!k21_%evs=o)(*=!jg1kc90yjbn'
...
# keeping static_root different from static_in_env
# python manage.py collectstatic needs to be run on installation
